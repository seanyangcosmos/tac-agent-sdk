...
User input:
${e}
`,i=await n.complete(t),r=u(i);return r?{segments:r.segments||[],parsedLayers:{intent:c(r.intent),resources:c(r.resources),risk_boundary:c(r.risk_boundary),execution_horizon:c(r.execution_horizon)}}:{segments:[],parsedLayers:{}}}async function v(e,n){let t=`
...
State:
${JSON.stringify(e)}
`,i=await n.complete(t),r=u(i);return r||{intent:{valid:!1,reason:"LLM returned non-JSON output"},resources:{valid:!1,reason:"LLM returned non-JSON output"},risk_boundary:{valid:!1,reason:"LLM returned non-JSON output"},execution_horizon:{valid:!1,reason:"LLM returned non-JSON output"}}}async function k(e,n){let t=`
...
State:
${JSON.stringify(e)}
`,i=await n.complete(t);return u(i)}async function w(e,n,t){let i=`
